...
; Function Attrs: uwtable
define linkonce_odr void @_Z4testIfEvv() #2 {
  ...
  %4 = load float*** %a, align 8
  %5 = load float*** %b, align 8
...
; <label>:14                                      ; preds = %11
  ...
  %22 = getelementptr inbounds float* %21, i64 %16
  %23 = load float* %22, align 4
  %24 = fdiv float %23, 2.621440e+05
  %25 = load float* %avg, align 4
  %26 = fadd float %25, %24
...
; <label>:34                                      ; preds = %7
  %35 = load float* %avg, align 4
  %36 = call %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* @_ZSt4cout, float %35)
  %37 = call %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %36, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  ret void
}

; Function Attrs: uwtable
define linkonce_odr float** @_Z16make_test_matrixIfEPPT_v() #2 {
  %data = alloca float**, align 8
  %i = alloca i32, align 4
  %i1 = alloca i32, align 4
  %j = alloca i32, align 4
  %1 = call noalias i8* @_Znam(i64 4096) #5
...
; <label>:6                                       ; preds = %3
  %7 = call noalias i8* @_Znam(i64 2048) #5
  %8 = bitcast i8* %7 to float*
  %9 = load i32* %i, align 4
  %10 = sext i32 %9 to i64
  %11 = load float*** %data, align 8
...
; <label>:44                                      ; preds = %17
  %45 = load float*** %data, align 8
  ret float** %45
}

; Function Attrs: uwtable
define linkonce_odr void @_Z14SeqMatrixMult3IfEviPPT_S2_S2_(i32 %size, float** noalias %m1, float** noalias %m2, float** noalias %result) #2 {
  %1 = alloca i32, align 4
...
; <label>:21                                      ; preds = %17
  ...
  %38 = getelementptr inbounds float* %37, i64 %32
...
; <label>:46                                      ; preds = %17
  ...
  %55 = getelementptr inbounds float* %54, i64 %49
...
; Function Attrs: uwtable
define linkonce_odr void @_Z9TransposeIfEviPPT_(i32 %size, float** noalias %m) #2 {
  %1 = alloca i32, align 4
  %2 = alloca float**, align 8
  %i = alloca i32, align 4
  %j = alloca i32, align 4
...
; <label>:14                                      ; preds = %10
  ...
  call void @_ZSt4swapIfEvRT_S1_(float* %22, float* %30)
  br label %31
...
define linkonce_odr void @_ZSt4swapIfEvRT_S1_(float* %__a, float* %__b) #3 {
  ...
  %7 = load float** %1, align 8
  store float %6, float* %7, align 4
  %8 = load float* %__tmp, align 4
  %9 = load float** %2, align 8
